...
[Cheat Sheet Functions]() | Custom made functions for the purpose of making coding just a little bit easier! | function creation, data analytics.
[Neural Network for Pattern Recognition and Analyzation]() | Creation of a neural network for the purpose of reading CSV/JSON files and locating any possible numerical patterns, diplay those patterns, and show a 1y, 5y, and 10y forecast of said pattern | Pandas, Pytorch, NumPy, Machine Learning.
